...
static void GPIOSetup( void ){
	...
	//Initialize lcds
	//Red - Port 0, Amber - Port 1, Green - Port 2
	...
	//Setup SPC
	//Reset - P8 , Clock - P7, Data - P6
	GPIO_InitTypeDef SPC_init;
	SPC_init.GPIO_Pin = GPIO_Pin_6  | GPIO_Pin_7 | GPIO_Pin_8;
	SPC_init.GPIO_Mode = GPIO_Mode_OUT;
	SPC_init.GPIO_Speed = GPIO_Speed_50MHz;
	SPC_init.GPIO_OType = GPIO_OType_PP;
	SPC_init.GPIO_PuPd = GPIO_PuPd_NOPULL;

	GPIO_Init(GPIOC, &SPC_init);
...
static void ADCSetup( void ){
	...
	ADC_init.GPIO_Pin = GPIO_Pin_3;
	ADC_init.GPIO_Mode = GPIO_Mode_AN;
	ADC_init.GPIO_Speed = GPIO_Speed_50MHz;
//	ADC_init.GPIO_OType = GPIO_OType_;
